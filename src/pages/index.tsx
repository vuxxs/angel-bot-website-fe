  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-indigo-800">
      ...
      <header className="w-full flex justify-end p-5">
        <a
          href="https://discord.com/api/oauth2/authorize?client_id=1107632678829817956&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Flogin&response_type=code&scope=identify%20guilds"
