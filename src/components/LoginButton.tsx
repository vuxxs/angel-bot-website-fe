...
const LoginButton = () => {
  return (
    <header className="w-full flex justify-end p-5 space-x-4">
      <Link href="/usage">
        <div className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded border-white border-2">
          Usage
        </div>
      </Link>
      <a
